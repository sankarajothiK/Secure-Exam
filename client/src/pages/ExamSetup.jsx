...
const ExamSetup = () => {
  ...
  const [step, setStep] = useState(1); // 1: Permissions, 2: Selfie, 3: Aadhaar
            ...
            <div className="text-center">
              ...
              {!cameraPerm || !micPerm ? (
                <button
                  ...
                  className="px-6 py-3 rounded-xl bg-primary-600 hover:bg-primary-700 text-white font-semibold transition inline-flex items-center gap-2 shadow"
                >
                ...
                <div className="text-emerald-500 font-semibold flex items-center justify-center gap-2">
                  ...
                  All Permissions Granted. Loading Next Step...
                </div>
              )}
            </div>
          )}
